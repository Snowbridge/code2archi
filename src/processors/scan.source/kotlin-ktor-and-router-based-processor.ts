...
export class KotlinKtorAndRouterBasedProcessor extends AbstractProcessor<ScanAppInput, ScanAppOutput> {
  readonly id: ProcessorId = {
    groupId: "scan.source.rest.controller.kotlin",
    artifactId: "ktor-and-router-based",
  };
  ...
  private scanKotlinFile(fileContext: KotlinFileContext): RestController[] {
    ...
    let compilationUnit;
    try {
      compilationUnit = parseKotlinSourceFile(source, { fileBaseName });
    } catch (error) {
