...
const GENERATOR_COORDINATE = "generate.elements.application:application-components-from-modules";
...
export class ApplicationComponentsFromModulesProcessor extends AbstractProcessor<
