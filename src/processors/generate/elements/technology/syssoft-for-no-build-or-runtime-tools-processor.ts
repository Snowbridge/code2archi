...
import { BUILD_TOOLS_AND_RUNTIMES_FOLDER } from "./syssoft-for-build-systems-and-runtimes-processor.js";

const GENERATOR_COORDINATE = "generate.elements.technology:syssoft-for-no-build-or-runtime-tools";

export class SyssoftForNoBuildOrRuntimeToolsProcessor extends AbstractProcessor<
