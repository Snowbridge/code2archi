...
const GENERATOR_COORDINATE = "generate.elements.application.rest:declared-api-contracts";

const REQUIRED_PROFILES: readonly ArchiProfile[] = [ApiContractProfile.create()];

export class DeclaredApiContractsProcessor extends AbstractProcessor<
