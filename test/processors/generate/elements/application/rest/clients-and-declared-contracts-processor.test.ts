...
describe("ClientsAndDeclaredContractsProcessor", () => {
  ...
  it("coexists with controllers-declared-api-contracts for shared FQCN", () => {
    ...
    const declaredProcessor = new ControllersDeclaredApiContractsProcessor();
    ...
    store.addCreateIntents(
      "generate.elements",
      { groupId: "generate.elements.application.rest", artifactId: "controllers-declared-api-contracts" },
      declaredOutput,
    );
