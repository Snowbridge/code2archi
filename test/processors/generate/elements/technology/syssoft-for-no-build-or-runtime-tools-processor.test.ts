...
import { SyssoftForNoBuildOrRuntimeToolsProcessor } from "../../../../../src/processors/generate/elements/technology/syssoft-for-no-build-or-runtime-tools-processor.js";
import {
...
describe("SyssoftForNoBuildOrRuntimeToolsProcessor", () => {
  it("exposes generate.elements.technology coordinates", () => {
    const processor = new SyssoftForNoBuildOrRuntimeToolsProcessor();

    assert.deepEqual(processor.id, {
      groupId: "generate.elements.technology",
      artifactId: "syssoft-for-no-build-or-runtime-tools",
    });
  ...
  it("creates unknown Maven build and Java runtime markers when module artifact exists", () => {
    ...
    assert.equal(
      ...
      "generate.elements.technology:syssoft-for-no-build-or-runtime-tools",
    );
