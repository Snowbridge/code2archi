...
import {
  ...
  CodeRepositoriesProcessor,
} from "../../../../../src/processors/generate/elements/technology/code-repositories-processor.js";
import {
...
describe("CodeRepositoriesProcessor", () => {
  ...
  it("creates Artifact in Code repositories for repo without namespace", () => {
    ...
    assert.equal(generatorProperty?.value, "generate.elements.technology:code-repositories");
