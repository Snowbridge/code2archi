...
import { KotlinRestControllerAnnotationBasedProcessor } from "../../../../../../src/processors/scan/extract/kotlin/rest/controller-annotation-based-processor.js";
...
describe("KotlinRestControllerAnnotationBasedProcessor", () => {
...
<project>
  ...
  it("accepts modules with kotlinJvmTarget when java version is unknown", () => {
    ...
    store.addCreateIntents(
      "scan.extract",
      { groupId: "scan.extract.assembly.gradle", artifactId: "test" },
      { entities: { ApplicationModule: [module] } },
    );
