...
import { AnnotationBasedProcessor } from "../../../src/processors/scan.source/annotation-based-processor.js";
...
describe("AnnotationBasedProcessor", () => {
...
`,
    ...
    const processor = new AnnotationBasedProcessor();
